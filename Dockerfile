ARG ARCH=
FROM ${ARCH}jimsihk/alpine-php-nginx:80.25.0
...
# renovate: datasource=git-refs depName=https://github.com/moodle/moodle branch=MOODLE_400_STABLE
ARG ARG_MODOLE_GIT_COMMIT='fdbcfa1b153ee8b3cf863044f7b28f8b3b7a9500'
